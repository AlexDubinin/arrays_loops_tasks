 ...
 * Есть переменные: $row - кол-во строк в таблице, $cols - кол-во столбцов в таблице. Есть список цветов,
...
$row = 10; //Количество строк в таблице
$cols = 10;   //Количество столбцов в таблице
